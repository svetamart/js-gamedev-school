...
Solder.prototype.updateHealthBar = function (hp) {
    var maxHealth = Solder.HP;
    var healthPercentage = hp / maxHealth;
    var newWidth = this.healthBar.getContentSize().width * healthPercentage;

    this.healthBar.setPreferredSize(cc.size(newWidth, this.healthBar.getContentSize().height));
};
